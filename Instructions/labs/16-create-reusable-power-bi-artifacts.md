...
lab:
  ...
  description: In this task, you will create a new report that uses a live connection to the Sales Analysis - Create reusable Power BI artifacts dataset, which you published in the previous exercise.
  duration: 45 minutes
  level: 200
  islab: true
  primarytopics:
